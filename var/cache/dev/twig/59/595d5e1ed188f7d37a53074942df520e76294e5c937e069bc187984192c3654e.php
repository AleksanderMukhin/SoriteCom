...
class __TwigTemplate_389cb2c7feb8cf595a14b81573233ff2e9db4ccc8647f91e8d121d1f2e6809f9 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <div class=\"metrics\">
        ...
        // line 68
        yield (((0 !== CoreExtension::compare(Twig\Extension\CoreExtension::lengthFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 68, $this->source); })()), "fallbackLocales", [], "any", false, false, false, 68)), 1))) ? ("s") : (""));
        yield "</span>
        </div>
    </div>
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                ...
                yield "
                    ";
                // line 193
                if ((1 === CoreExtension::compare(Twig\Extension\CoreExtension::lengthFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["message"], "parameters", [], "any", false, false, false, 193)), 0))) {
                    // line 194
...
{% endmacro %}
", "@WebProfiler/Collector/translation.html.twig", "C:\\wamp64\\www\\usertest\\usertest\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\translation.html.twig");
    }
}
