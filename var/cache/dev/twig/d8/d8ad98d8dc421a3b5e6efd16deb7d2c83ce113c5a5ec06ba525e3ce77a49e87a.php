...
class __TwigTemplate_c457f79f9c960d3f1d682de01edff6cb195e24a2ee8c1ca197869d77dd639f37 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <div class=\"sf-tabs\">
            ...
            foreach ($context['_seq'] as $context["name"] => $context["calls"]) {
                // line 96
                yield "                <div class=\"tab ";
                yield (((0 === CoreExtension::compare(Twig\Extension\CoreExtension::lengthFilter($this->env, $context["calls"]), 0))) ? ("disabled") : (""));
                yield "\">
                    <h3 class=\"tab-title\">";
                // line 97
                ...
                yield "</span></h3>
                    ...
                    <div class=\"tab-content\">
                        ";
                // line 100
                if ((0 === CoreExtension::compare(Twig\Extension\CoreExtension::lengthFilter($this->env, $context["calls"]), 0))) {
                    // line 101
                    yield "                            <div class=\"empty\">
...
$context["key"], "hit_read_ratio"))) {
                        ...
                        yield "                                        </span>
                                        <span class=\"label\">";
                        // line 118
                        (((0 === CoreExtension::compare($context["key"], "hit_read_ratio"))) ? (yield "Hits/reads") : (yield Twig\Extension\EscaperExtension::escape($this->env, Twig\Extension\CoreExtension::capitalizeStringFilter($this->env, $context["key"]), "html", null, true)));
                        yield "</span>
                                    </div>
                                    ";
                        // line 120
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/cache.html.twig", "C:\\wamp64\\www\\usertest\\usertest\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\cache.html.twig");
    }
}
