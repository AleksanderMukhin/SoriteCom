...
class __TwigTemplate_73b137f8fd7615713e645ba2803e9139aef053e03ba4aacf94b6404e941bd445 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <span class=\"label ";
        ...
        ";
        // line 71
        if ((1 === CoreExtension::compare(Twig\Extension\CoreExtension::lengthFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 71, $this->source); })()), "messages", [], "any", false, false, false, 71)), 0))) {
            // line 72
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "C:\\wamp64\\www\\usertest\\usertest\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\mailer.html.twig");
    }
}
