...
class __TwigTemplate_84acd8959aa9a5299b4a90d27e1e156f356276206df1b3de24794f14b5216983 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <span class=\"label ";
        ...
        ";
        // line 74
        if ((1 === CoreExtension::compare(Twig\Extension\CoreExtension::lengthFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 74, $this->source); })()), "messages", [], "any", false, false, false, 74)), 0))) {
            // line 75
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/notifier.html.twig", "C:\\wamp64\\www\\usertest\\usertest\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\notifier.html.twig");
    }
}
